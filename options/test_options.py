...
class TestOptions:
    ...
    def initialize(self):
        ...
        #test時候的人臉語義分割
        self.parser.add_argument('--mask_path', type=str,
                                 help='Path to mask output directory')
        self.parser.add_argument('--background_path', type=str,
                                 help='Path to background output directory')
        self.parser.add_argument('--face_path', type=str,
                                 help='Path to face output directory')
        self.parser.add_argument('--orig_img', type=str,
                                 help='Path to face output directory')
